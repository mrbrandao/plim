#### Plim
=======
Plim √© um pequeno projeto para automa√√o em casas, edificios e outros usando Raspberry Pi/Banana Pi/Arduino's
...
Instale o nginx no Raspberry, fa√a o clone do plim na raiz do nginx.
